...
| 2026-03-05 | Initialized Go module (`go mod init github.com/RAiWorks/RGo`), set `go 1.21` | Phase A — Go auto-detected 1.25.6, manually set to 1.21 for compatibility |
